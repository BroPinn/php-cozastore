...
<section class="section-slide">
    <div class="wrap-slick1">
        <div class="slick1">
            ...
            <div class="item-slick1" style="background-image: url(<?= htmlspecialchars(file_exists(ROOT_DIR . '/' . $slider['slider_image']) ? $slider['slider_image'] : 'https://cdn.jsdelivr.net/gh/BroPinn/cdn-file@main/client/images/placeholder.jpg') ?>);">
