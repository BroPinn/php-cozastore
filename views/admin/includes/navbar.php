...
if (isset($_SESSION['username'])) {
  ...
  $adminData = $adminModel->getAdminData($_SESSION['username']);
}
?>
          ...
          <li class="nav-item topbar-user dropdown hidden-caret">
            <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
              ...
              <span class="profile-username">
                ...
                <span class="fw-bold"><?php echo htmlspecialchars($adminData['username']); ?></span>
              </span>
            </a>
                ...
                <li>
                  <div class="user-box">
                    ...
                    <div class="u-text">
                      ...
                      <p class="text-muted"><?php echo htmlspecialchars($adminData['gmail']); ?></p>
